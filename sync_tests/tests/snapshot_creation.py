...
def upload_snapshot_creation_results_to_aws(env):
    ...
    if not aws_db_utils.add_single_row_into_db(db_snapshot_creation_test_summary_table, col_to_insert, val_to_insert):
...
def main():
    ...
    utils_db_sync.print_color_log(utils_db_sync.sh_colors.WARNING, f"Snapshot creation script result: {snapsot_creation_outcome}")
