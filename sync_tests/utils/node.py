...
def get_node_config_files(
    env: str, conf_dir: pl.Path, node_topology_type: str = None, use_genesis_mode: bool = False
) -> None:
    ...
    filenames = [
        ...
        (env + "/byron-genesis.json", f"{conf_dir}/byron-genesis.json"),
        (env + "/shelley-genesis.json", f"{conf_dir}/shelley-genesis.json"),
        (env + "/alonzo-genesis.json", f"{conf_dir}/alonzo-genesis.json"),
        (env + "/conway-genesis.json", f"{conf_dir}/conway-genesis.json")
    ]
